...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	FROM postreps AS pr INNER JOIN users AS u ON pr.user_id = u._id WHERE pr.parent_id = ? AND pr.is_deleted != 1")){
		...
		if($stmt->fetch()){
			...
			echo json_encode(array('postrepsfromparent'=>$response));
			/*
