...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2018 at 03:16 AM
...
(78, 6, 2, NULL, 'oy par', 1, '2018-03-19T12:41:42Z', NULL),
(79, 6, 2, NULL, 'oi par watup', 1, '2018-03-19T12:46:00Z', NULL),
(80, 6, 2, NULL, 'jojojo', 1, '2018-03-19T12:49:27Z', NULL),
(81, 6, 2, NULL, 'par wat up', 1, '2018-03-19T12:51:42Z', NULL);
...
(8, 2, 'Trying image out', 'Successful image upload', 2, '2018-03-20T09:35:28Z', 'uploads/posts/a5ae355.jpg', 57, 0);
...
ALTER TABLE `posts`
  ADD PRIMARY KEY (`_id`),
  ADD KEY `_id` (`_id`),
  ADD KEY `user_id` (`user_id`,`topic_id`,`faci_link`),
  ADD KEY `topic_id` (`topic_id`),
  ADD KEY `faci_link` (`faci_link`);
...
--
ALTER TABLE `facilities`
  ADD CONSTRAINT `facilities_ibfk_1` FOREIGN KEY (`vet_id`) REFERENCES `veterinarians` (`_id`);
...
ALTER TABLE `posts`
  ...
  ADD CONSTRAINT `posts_ibfk_3` FOREIGN KEY (`faci_link`) REFERENCES `facilities` (`faci_id`);
